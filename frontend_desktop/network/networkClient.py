...
class NetworkClient:
    ...
    def _dispatch(self, raw: str):
        ...
        handlers = {
            ...
            "NEW_MESSAGE_NOTIFICATION":    self._on_new_message_response,
            "NEW_CHATROOM_RESPONSE":       self._on_new_chatroom_response,
            "NEW_CHATROOM_NOTIFICATION":   self._on_new_chatroom_response,
            "ADD_USER_RESPONSE":           self._on_add_user_response,
            "ADD_USER_NOTIFICATION":       self._on_add_user_response,
            "REMOVE_USER_RESPONSE":        self._on_remove_user_response,
            "REMOVE_USER_NOTIFICATION":    self._on_remove_user_response,
            "REQUEST_RESPONSE":            self._on_request_response,
            "REQUEST_NOTIFICATION":        self._on_request_response,
